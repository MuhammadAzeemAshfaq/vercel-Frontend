...
function Complaints() {
  ...
  const registerComplaint = async (e) => {
    ...
    const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/complaint/register`, {
      method: "POST",
      headers: {
  ...
  useEffect(()=> {
    ...
    const fetchComplaints = async () => {
      const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/complaint/student`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
