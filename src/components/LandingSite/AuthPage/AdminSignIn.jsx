...
export default function AdminSignIn() {
  ...
  const getHostel = async () => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/admin/get-hostel`, {
        method: "POST",
        headers: {
  ...
  let login = async (event) => {
    ...
    let response = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/auth/login`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (result.success) {
      ...
      let admin = await fetch(`${import.meta.env.VITE_SERVER_URL}/api/admin/get-admin`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
